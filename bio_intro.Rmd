...
```{r echo=FALSE, out.width = '90%'}
knitr::include_graphics("./mobaxterm windows.png")
```
...
```
```{r echo=FALSE, out.width = '90%'}
knitr::include_graphics("./interactive session (1).png")
```
...
Prior to importing data into QIIME, the data will be assessed with Fastp. This step functions to assess overall sequence quality and to remove low quality sequence data. Output information will be in a html format and will include:
...
knitr::include_graphics("./shannon_alpha_long.png")
```
